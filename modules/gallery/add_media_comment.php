...
try {
    notify_user((int)$media['user_id'], 'photo_comment', (int)$user['id'], $mediaId, (int)$commentId);
    notify_mentions($content, (int)$user['id'], $mediaId, 'mention_comment_photo', (int)$commentId);
} catch (\Throwable $e) {
